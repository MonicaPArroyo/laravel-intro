...
<label class="uppercase text-gray-700 dark:text-gray-100 text-xs">Slug</label>
<span class="text-xs text-red-600">@error('slug') {{ $message }} @enderror</span>
<input type="text" name="slug" class="rounded dark:text-gray-800 border-gray-600 w-full mb-4" value="{{ old('slug', $post->slug) }}">
